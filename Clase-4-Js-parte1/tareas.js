...
function promedioResultadosTest(resultadosTest) {
  ...
  resultadosTest.forEach(function(value){
...
function todosIguales(arreglo) {
  ...
  let result=0; // result=0->iguales result>0->hay diferentes
  let anterior=arreglo[0];//lo igualo al primer valor del arreglo
...
function mayorACien(array) {
  ...
  const arrayMayorCien = array.filter(function(value){
